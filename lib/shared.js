 ...
 */
/** Official free-tier model ids, straight from the OpenCode Zen docs
 * pricing table (every row priced "Free"), fetched 2026-08-24:
 * https://opencode.ai/docs/zh-cn/zen/
 * Suffix-only ids the endpoint also serves (x-preview-f-free,
 * deepseek-v4-flash-free, laguna-s-2.1-free) are paid workhorses, not in
 * the free table, and never offered for adoption on the free route. */
...
/** A free-tier live entry is one the official docs price as Free, or an id
 * this user already configured (stays managed, never flagged delisted). */
